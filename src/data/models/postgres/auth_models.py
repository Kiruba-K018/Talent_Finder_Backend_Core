...
class User(Base):
    ...
    org_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), ForeignKey("organizations.org_id"), nullable=True)
...
class RevokedToken(Base):
    ...
    jti: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("refresh_tokens.jti"), primary_key=True)
